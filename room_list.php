  ...
  <div class="grid">
    <?php foreach ($rooms as $r): ?>
      <article class="span-4 room-card">
        <a class="room-media" href="room.php?id=<?= $r['id'] ?>">
        ...
        <div class="room-body">
          ...
          <div class="actions">
            ...
            <?php endif; ?>
            <a class="btn primary" href="room.php?id=<?= $r['id'] ?>#book">Book</a>
          </div>
        </div>
      </article>
    <?php endforeach; ?>
    <?php if (!$rooms): ?>
      <div class="span-12 card"><p class="muted" style="margin:0">No rooms match the selected guest count. Try reducing guests or check different dates.</p></div>
    <?php endif; ?>
  </div>
</section>
